...
def external_scan(target = ''):
        debug_filename = './output/debug.log'
        output_filename = './output/Rob1n-' + target + '.log'
        ...
        output_file.write('__________      ___.   ____        ')
        output_file.write('\______   \ ____\_ |__/_   | ____  ')
        output_file.write(' |       _//  _ \| __ \|   |/    \ ')
        output_file.write(' |    |   (  (_) ) \_\ \   |   |  \\')
        output_file.write(' |____|_  /\____/|___  /___|___|  /')
        output_file.write('        \/           \/         \/ ')
        output_file.write('      The Pentesters Sidekick      ')
        output_file.write('          By: StingraySA           ')
        output_file.write('-----------------------------------')
